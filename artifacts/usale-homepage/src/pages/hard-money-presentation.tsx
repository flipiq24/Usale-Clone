...
function getHMLScripts(company: string): string[] {
  return [
    // 0: Welcome
    `Welcome, ${company}. My name is Tony Diaz. I've been in this business 32 years. Over eleven hundred flips. I've borrowed from Kiavi, Anchor, Genesis, and private individuals. At one point I was the second-largest borrower at Anchor Loans. So when I talk about hard money, I'm talking as someone who's been on the other side of your desk for three decades.`,
    ...
    // 6: The Math
    `Here's why this scales. We're targeting the 75 most active MSAs. In each MSA, the top five tier-one operators — the ones doing the most volume. That's our target universe. Today, a top operator does about two hard money deals a month. Our technology gets them to do more. Our target: 375 operators over three years. Average hard money loan is $257K. 375 operators × 2 loans a month × $257K = $192 million a month in new originations. At a one percent origination fee, that's $1.9 million a month in new fee income — without having to pay a sales team. That sounds interesting.`,

    // 7: The Ask
    `We also have a barrier to entry. We normally charge operators $100,000 to join — comparable to a HomeVestors or KeyGlee franchise. I don't want a sales team. I don't want overhead. I want distribution partners who already have the data. Here's how we all win. $250,000 initial investment from ${company}. We drop the operator fee to $10,000 — remove the barrier, but keep skin in the game. You get ownership in the technology. You get 20 tier-one operators delivered — we have seven today, we'll build to 20 before you fund a dollar. Those borrowers are yours. No revenue share, no referral fee. Your blended borrower-acquisition cost today runs 0.4 to 0.5 percent of the loan amount, plus your cost to acquire each client. With us, you don't need reps. We become your reps — except we work for the borrower first, which is why they stay sticky. Phase two, after proof of concept: national partnership. Bigger investment, bigger ownership. That's where 20 operators becomes 375. That's where $192 million a month becomes real. That's where we both win.`,
