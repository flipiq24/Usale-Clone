...
function getScripts(broker: BrokerData) {
  return [
    `Welcome ${broker.name}, my name is Tony Diaz. I am the founder of You-Sale. I've been in the business for thirty-two years and done over eleven hundred flips. We are now a technology company that specializes in empowering investors and the investor-friendly agents who transact with them. I'm excited to show you our powerful data and how we can empower your brokerage and your agents!`,
    ...
    `So what do we need from you? Set up a meeting with our team to discuss how we can get your agents signed up to the waiting list. We'll demo the technology to show you our data and powerful tools. We'll explain how your agents can get paid without a listing using the white-label website. And we'll show you how to use You-Sale to recruit investor-friendly agents. Schedule a meeting. Do a demo. Create an unfair advantage for your agents. I know you know the AI wave is here \u2014 this is the way to easily get behind great technology without the sales pitch.`,
    `Before we wrap up, ${broker.name}, I'd love to get your quick feedback. Are you currently flipping or wholesaling? Do you see value in what You-Sale can offer? Please rate your interest on a few key areas \u2014 seeing a full demo, learning how to do more flips, recruiting investor-friendly agents, and training your agents to get paid without a listing. Drop any comments you have, and if you'd like to schedule a follow-up meeting, you can do that right here. And make sure to download the You-Sale Broker Playbook \u2014 it's got everything we covered today and more. We're looking forward to working with you.`,
  ];
}
...
const HIGHLIGHT_CUES: [number, number][][] = [
  [[0, 0], [0.09, 1], [0.3, 2]],
  [[0, 0], [0.07, 1], [0.1, 2], [0.12, 3], [0.15, 4], [0.24, 5], [0.32, 6], [0.35, 7], [0.4, 8], [0.44, 9], [0.47, 10], [0.52, 11]],
  [[0, 0], [0.07, 1], [0.29, 2], [0.66, 3], [0.79, 4]],
  [[0.07, 0], [0.27, 1], [0.31, 2], [0.5, 3]],
  [[0.07, 0], [0.35, 1], [0.48, 2], [0.61, 3]],
  [[0.03, 0], [0.39, 1], [0.57, 2]],
  [[0.14, 0], [0.53, 1], [0.64, 2]],
  [[0, 0], [0.08, 1], [0.25, 2], [0.35, 3], [0.61, 4]],
  [[0, 0], [0.04, 1], [0.32, 2]],
  [[0.04, 0], [0.2, 1], [0.3, 2], [0.44, 3], [0.53, 4]],
  [[0, 0], [0.09, 1], [0.21, 2], [0.48, 3], [0.62, 4]],
];
...
function SectionWorkflow({ hl }: { hl: number }) {
  const paths = [
    ...
    { n: "2", t: "Agent Has a New Listing", body: "Post it on USale and coming soon on the MLS. Hundreds of local, active investors see it. Pick the buyer based on track record. Double-end. No fees." },
