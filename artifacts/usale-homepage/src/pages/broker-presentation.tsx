...
function getScripts(broker: BrokerData) {
  return [
    `${broker.name} \u2014 Tony Diaz, founder of USale. Quick background \u2014 thirty-two years in the business, over eleven hundred flips. But I'm not here to talk about me. I'm here because we pulled your data \u2014 and what we found is impressive. We put together a quick report showing what your brokerage has already accomplished with investor transactions, and how USale can help you do even more. This takes about five minutes. Let's get into it.`,
    ...
    `At a 2% average commission across two thousand eighty-eight transactions \u2014 your office has generated over $82.7 million in investor commissions. That's real money. Now here's the question \u2014 what if you could increase that by 20%? Not by working harder. Not by hiring more agents. Just by giving your agents access to a marketplace that puts more buyers in front of their deals. That's an additional $16.5 million. And it costs you nothing. Zero. Let me show you how.`,
    `USale is a frictionless, off-market marketplace. Think of it as an investor-focused MLS. No membership fees \u2014 ever. No transaction fees \u2014 ever. We don't compete with the MLS. We complement it. We simply connect your investor-friendly agents with every active, verified investor in the market. Full transparency \u2014 your agents can see track records, choose their buyer, and transact with confidence. That's it. It's really that simple, ${broker.name}.`,
    `Here's how your agents actually use it. Scenario one \u2014 your agent can't get the listing. Instead of walking away empty-handed, they invite the seller to USale. If an investor makes an offer and the seller accepts, the buyer pays your agent 2.5%. No listing needed. No contract needed. Your agent still gets paid. Scenario two \u2014 your agent HAS a listing. They post it on USale alongside the MLS. Hundreds of local investors see it immediately. Your agent picks the best buyer, double-ends the deal. No extra fees. Scenario three \u2014 your agent brings a buyer to the marketplace. When that buyer goes under contract on ANY property \u2014 your agent gets notified and earns the re-list. Automatically. Three ways to win. Zero downside.`,
    `This works because everyone gets what they need. The market needs inventory \u2014 we help surface it. You need transactions \u2014 we create more of them. Investors need first access to properties in your market \u2014 we deliver it. Nobody loses. Everybody wins.`,
    `So how does USale make money? We don't charge your agents anything. We don't monetize the marketplace. Here's what happens \u2014 your agent walks into a seller appointment with a real, data-backed cash offer from one of our investors. That gets attention. Most of the time, the seller says no to the cash offer \u2014 and your agent gets the listing instead. When the seller DOES accept the cash offer, we take a small share of the transaction. That's it. Your agents get a tool that wins them more listings. When a deal actually closes through an investor, we earn a small piece. Everybody wins.`,
    `${broker.name} \u2014 you already have the relationships, the agents, and the transaction history. We have the data, the technology, and the buyers. Put those together and you have an edge that no competing brokerage in your market can match. If you're ready to see this in action \u2014 schedule a demo. Takes fifteen minutes. We'll walk you through the platform, show you your agents' data live, and show you exactly how that $16.5 million opportunity works. And if you're not quite ready for a demo \u2014 download the USale Broker Playbook. It's got everything we covered today plus recruiting scripts, income projections, and a 90-day rollout plan. Either way, ${broker.name} \u2014 this is yours. No pressure. No pitch. Just a better way to do what you're already doing. Thanks for your time.`,
  ];
}
