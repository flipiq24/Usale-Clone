...
function getScripts(_inv: InvestorData) {
  return [
    ...
    `Thirty-two transactions. Seven-forty-eight average purchase, nine-eighty-two average resale. Seventy-seven percent purchase-to-future-value, ninety-seven list-to-sold. Fifty deals off-market, forty-five through the MLS. You're a real operator. Your primary entity — nineteen of the thirty-two run through one PO box. Your agent — Jose Diaz. Six with you, fifty-seven in his career, running most of your resales. Your capital — one lender, seventeen loans, eight-forty-seven average. That's your money. Your title — one company leads with ten, the rest spread across five others. The MLS and tax data isn't a hundred percent perfect. But it lets us know exactly how everyone operates and how they make money. We approach every agent, investor, and strategic partner the same way — we bring them value the way they make money.`,
