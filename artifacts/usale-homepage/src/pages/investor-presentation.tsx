...
function getScripts(_inv: InvestorData) {
  return [
    `My name is Tony Diaz. Thirty-two years in the business. Eleven hundred flips. Obsessed with data and technology. You're not here by accident — we found you through our proprietary data because you're a real operator. Give me four minutes. I'll show you your numbers the way nobody ever has. Then I'll tell you what we built — and you decide where the value is.`,
    `Thirty-two transactions. Seven-forty-eight average purchase. Nine-eighty-two average resale. Seventy-seven percent purchase-to-future-value. Ninety-seven list-to-sold. Fifty off-market. Forty-five MLS. You're a real operator. Your primary entity — nineteen of thirty-two through one PO box. Hacienda Heights. San Pedro. Long Beach. Your agent — Jose Diaz. Six with you, and Jose is running most of your resales. Your capital — one lender, seventeen loans, eight-forty-seven average. That's your money. Your title — one company leads with ten, the rest spread across five others. MLS and tax data isn't perfect — but it tells us exactly how everyone operates and how they make money. Every agent. Every investor. Every strategic partner. We approach them the same way — we bring them value the way they make money.`,
    `Here's the reality — I'm not going to convince you. You already know. AI is going to change this business. Fast. AI won't take your deals. Somebody using AI will. You're either in front of it — or behind it. Think about the last time an opportunity sat right in front of you and you jumped in too late. Eventually you'll be a user of U-Sale. It's a no-brainer — there's no catch. That's the magic taking us viral.`,
    `First movers win. Early adopters get the unfair advantage. Once a marketplace hits network effects, the people inside own the market. We're not on Facebook. We're not running ads. We have the data — that's how we found you. We don't charge ninety-nine bucks for a tool. The marketplace is a hundred percent free. That's not a discount — that's the model. The biggest platforms ever built were free. They didn't charge per use. They built the machine, and the transactions came. That's us.`,
    `Two of the largest national hard money lenders. Two of the largest national title companies. Already behind U-Sale. Not because we paid them — because they understand what we're building. A frictionless community where everybody wins. Our local market — just under half a million licensed individuals. Twelve thousand four hundred forty-eight of them are investor-friendly agents in Southern California. We educate investor-friendly agents on how they can double-end their listings. No fees. No strings. No middleman. Just value. And our investor-operators get first look. That's right — it's an unfair advantage.`,
    `The biggest dispo platform out there — without getting your wallet lifted. The best acquisition tool out there — with real AI intelligence behind it. If you're not seeing where this is going, we're not it. No harm done. Enjoy the free marketplace — and eventually you'll have no choice but to join. Because it makes sense. And it's free.`,
    `You already have the volume. The relationships. The discipline. Not every investor needs us. The only question is whether you want an unfair advantage. Give me fifteen minutes to show you the most advanced acquisition platform in the market. No pitch. You see the system live. You see the market data we use — live. And you choose how we bring you value — simply by using U-Sale, or becoming an early adopter on Command. Either way, we both win. We get a great buyer like you. You get off-market deals you otherwise wouldn't see. You can even monetize deals to the marketplace that you don't buy. You get the point — we all win. No catch. Looking forward to working with you.`,
  ];
}
...
const SEMANTIC_CUES: (SemanticCue[] | null)[] = [
  ...
  [
    ...
    { after: "MLS and tax data", step: 5, bufferMs: 100 },
  ],
      ...
      <div style={{ ...hVisible(hl, 0) }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <div style={{ padding: "24px 26px", background: "#fff", borderRadius: 14, border: "1px solid #E8571A30" }}>
            ...
            <div style={{ fontSize: 22, fontWeight: 800, color: "#2C3E50", lineHeight: 1.2 }}>The biggest dispo platform —</div>
