...
function getScripts(_inv: InvestorData) {
  return [
    `My name is Tony Diaz. Thirty-two years. Eleven hundred flips. We are obsessed with data and technology. You're not here by accident — we found you through our proprietary data because you're a real operator. Four minutes. I'm going to show you your numbers the way nobody's ever shown them to you. Then I'll tell you what we built — and you decide where the value is for you.`,
    `Thirty-two transactions. Seven-forty-eight average purchase, nine-eighty-two average resale. Seventy-seven percent purchase-to-future-value, ninety-seven list-to-sold. Fifty deals off-market, forty-five through the MLS. You're a real operator. Your primary entity — nineteen of the thirty-two run through one PO box. Hacienda Heights. San Pedro. Long Beach. Your agent — Jose Diaz. Six with you, fifty-seven in his career, running most of your resales. Your capital — one lender, seventeen loans, eight-forty-seven average. That's your money. Your title — one company leads with ten, the rest spread across five others. The MLS and tax data isn't a hundred percent perfect. But it lets us know exactly how everyone operates and how they make money. We approach every agent, investor, and strategic partner the same way — we bring them value the way they make money.`,
    `Here's the reality — I'm not going to try to convince you. You already know. AI is going to change this business. Fast. AI is not going to take your deals. Somebody using it will. You're either in front of it or behind it. Think about the last time an opportunity was right in front of you and you jumped in too late. Eventually you are going to be a user of U-Sale. It's a no-brainer.`,
...
const STATIC_HIGHLIGHT_CUES: [number, number][][] = [
  [[0, 0], [0.4, 1], [0.75, 2]],
  [[0, 0], [0.19, 1], [0.37, 2], [0.50, 3], [0.57, 4], [0.67, 5]],
  [[0, 0], [0.30, 1], [0.65, 2]],
  [[0, 0], [0.30, 1], [0.65, 2]],
  [[0, 0], [0.30, 1], [0.65, 2]],
  [[0, 0], [0.50, 1]],
