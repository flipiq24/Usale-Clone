...
function getScripts(_inv: InvestorData) {
  return [
    ...
    `Thirty-two transactions. Seven-forty-eight average purchase. Nine-eighty-two average resale. Seventy-seven percent purchase-to-future-value. Ninety-seven list-to-sold. Fifty off-market. Forty-five MLS. You're a real operator. Your primary entity — nineteen of thirty-two through one PO box. Your agent — Jose Diaz. Six with you. Jose is doing most of your resales. Your capital — one lender, seventeen loans, eight-forty-seven average. That's your money. Your title — one company leads with ten, the rest spread across five others. MLS and tax data isn't perfect — but it tells us exactly how everyone operates and how they make money. Every agent. Every investor. Every strategic partner. We approach them the same way — we bring them value the way they make money.`,
    ...
    `Two of the largest national hard money lenders. Two of the largest national title companies. Already behind U-Sale. Not because we paid them — because they understand what we're building. A frictionless community where everybody wins. Our local market — just under half a million licensed individuals. Twelve thousand four hundred forty-eight of them are investor-friendly agents in Southern California. Investor friendly agents double-end their listings. No fees. No strings. No middleman. Just value. And our investor-operators get first look. Then we go national.`,
