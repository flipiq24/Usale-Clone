...
function getScripts(_inv: InvestorData) {
  return [
    `My name is Tony Diaz. I got into real estate because I wanted to build generational wealth through real estate investing. Thirty-two years in the business. Over eleven hundred flips. Obsessed with technology and data. By the way — you're not here by accident. We found you through our proprietary data. We know who you are, who you work for, how your organization makes money, and the splits you get. Give me four minutes. I'm going to show you your numbers the way nobody's ever shown them to you.`,
    `Here's what our data shows us. Every agent you've worked with. Every buyer on the other side of your deals. How many they purchase from you, how often, and who they borrow money from. There's a reality. You're there because the operator you work for built something real. Community. Training. Culture. They move deals. That's most of the value — and I respect it. I started exactly where you are. I worked for the man. But a lot of what you're doing is the hard way. Not because they're bad operators — because they focus on building teams. We focus on building the machine that builds the teams.`,
    `Here's the reality — I'm not trying to convince you. You already know. AI is going to change this business. Fast. AI is not going to take the deals. Somebody like me — using AI — will. Think about the last time an opportunity was right in front of you and you jumped in too late. You know the feeling. This is one of those moments.`,
    `First movers win. Early adopters get the unfair advantage. Once a marketplace hits network effects, the people in the inner circle own the biggest share of the market. We're not on Facebook. We're not running ads. We're not gurus or coaches. We have the data — that's how we found you. We don't charge three hundred bucks a month and lift your wallet like other wholesale marketplaces. U-Sale is a hundred percent free. That's not a discount — that's the model. The biggest platforms ever built were free. They built the machine, and the transactions came. That's us.`,
    `Two of the largest national hard money lenders and two of the largest national title companies are already behind U-Sale. Not because we paid them — because they understand what we're building. Twelve thousand four hundred forty-eight investor-friendly agents in Southern California. We know exactly who they are. I know who they sell to. I know how they make money. We don't beg them for off-market deals — we show them how to double-end their listings with zero middleman, no fees, no strings. They bring the deals to us because they get instant access to all active buyers — no wholesalers — and they get to pick them by track record. Ask yourself — how are you going to compete with that? You call an agent asking for an off-market deal. I go to that same agent and say: over a thousand active local buyers, you pick, you see their track record, you double-end it, nothing comes out of your pocket. What are you going to offer that beats that? Unless you have a relationship stronger than the dollar — and we both know how Realtors work — you can't.`,
    `Imagine this. Sell your deal to the highest bidder. Don't give up seventy or eighty percent to the house. Know every investor-friendly agent in your market, how they transact, who they work with. Three times more efficient. AI running your comps, writing your contracts, following up for you. Think InvestorLift — zero cost. Think the best acquisition tool out there — with real AI intelligence behind it. Let me be straight — this doesn't mean you work less. It means you work smarter, do a lot more, and keep what you earn. If full-time isn't you, we're not it. No harm done.`,
    `I'm not selling you anything. I don't charge three hundred bucks a month. I'm not a coach. I'm not a guru. I don't need to sell you a thousand-dollar course that turns into fifteen thousand. I don't need everybody — I need the right people. And I'm inviting you for a reason. I know who you are. I know how many transactions you do. If you're willing to work as hard as I did, I'll show you how to make a million and a half a year without somebody else taking most of it. Simple math and a great system — not magic. Fifteen minutes. You see the system live. You see your market live. You decide. If you're hungry — if you're that person looking to make a difference — we're looking for you. If you're part-time, still figuring it out, no pressure — I get it. This isn't for everybody. Looking forward to talking to you soon.`,
  ];
}

const SECTION_TITLES = ["Welcome", "Your Data", "AI Reality", "First Movers", "Marketplace", "The System", "Your Move"];

const STATIC_HIGHLIGHT_COUNTS = [3, 4, 3, 3, 3, 3, 3];
...
const SEMANTIC_CUES: (SemanticCue[] | null)[] = [
  null,
  [
    { after: "Every agent you've worked with", step: 1, bufferMs: 100 },
    { after: "buyer on the other side", step: 2, bufferMs: 100 },
    { after: "who they borrow money from", step: 3, bufferMs: 100 },
  ],
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "65vh", textAlign: "center", gap: 32, background: "#FFFFFF", borderRadius: 16, padding: "48px 32px" }}>
      <div style={{
        ...
        Prepared for {INVESTOR.legalName}
      </div>
      <h1 style={{ fontSize: "clamp(38px,6vw,68px)", fontWeight: 700, color: "#2C3E50", margin: 0, lineHeight: 1.1, letterSpacing: "-0.03em", ...introReveal(hl, 1) }}>
        You're not here <span style={{ color: "#E8571A" }}>by accident</span>.
      </h1>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, ...introReveal(hl, 3) }}>
        <p style={{ fontSize: 20, color: "#2C3E50", maxWidth: 640, lineHeight: 1.6, margin: 0, fontWeight: 600 }}>
          Tony Diaz · 32 years · 1,100+ flips · obsessed with technology and data.
        </p>
        <p style={{ fontSize: 15, color: "#6c757d", margin: 0, maxWidth: 640 }}>
          We found you through our data. We know who you work for, how the org makes money, and the splits you get. Four minutes — your numbers the way nobody's ever shown you.
        </p>
      </div>
    </div>
  );
...
const TABS = [
  { key: "agents", label: "Agents You've Worked With" },
  { key: "entities", label: "Buyers on the Other Side" },
  { key: "lenders", label: "Lenders Backing Those Buyers" },
  { key: "titles", label: "Title Companies in the Loop" },
] as const;
...
function SectionData({ hl, onTabChange }: { hl: number; onTabChange?: (t: TabKey) => void }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16, paddingTop: 8 }}>
      <div>
        <div style={{ fontSize: 12, fontWeight: 700, color: "#E8571A", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>What our data shows us</div>
        <h2 style={{ fontSize: "clamp(22px,3.5vw,32px)", fontWeight: 700, color: "#2C3E50", margin: 0, lineHeight: 1.2 }}>
          The operator built something real. <span style={{ color: "#E8571A" }}>A lot of it is the hard way.</span>
        </h2>
        <p style={{ fontSize: 14, color: "#6c757d", margin: "8px 0 0", maxWidth: 760 }}>
          Every agent you've worked with. Every buyer on the other side of your deals. How often, and who they borrow money from. We focus on building the machine that builds the teams.
        </p>
      </div>
...
function SectionTopDown({ hl }: { hl: number }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 22, minHeight: "60vh", justifyContent: "center", maxWidth: 880, margin: "0 auto" }}>
      <div style={{ ...hVisible(hl, 0) }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: "#E8571A", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 10 }}>The Marketplace That Changes Everything</div>
      ...
      <div style={{ padding: "26px 30px", background: "linear-gradient(135deg, #E8571A 0%, #c44e00 100%)", borderRadius: 16, color: "#fff", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap", ...hVisible(hl, 1) }}>
        <div style={{ flex: "1 1 320px" }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 800, marginTop: 6, lineHeight: 1.25 }}>Investor-friendly agents. Double-end their listings — no middleman, no fees, no strings.</div>
        </div>
      ...
      <div style={{ padding: "20px 24px", borderLeft: "4px solid #2C3E50", background: "#fff", borderRadius: "0 12px 12px 0", fontSize: 16, color: "#2C3E50", lineHeight: 1.55, ...hVisible(hl, 2) }}>
        You call an agent asking for an off-market deal. <b>I go to that same agent</b> with over a thousand active local buyers — they pick by track record, double-end it, nothing out of pocket. <span style={{ color: "#E8571A", fontWeight: 700 }}>What are you going to offer that beats that?</span>
      </div>
    </div>
  );
}
...
function SectionSystem({ hl }: { hl: number }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 26, minHeight: "60vh", justifyContent: "center", maxWidth: 920, margin: "0 auto" }}>
      <div style={{ ...hVisible(hl, 0) }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: "#E8571A", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 10 }}>The System · Imagine This</div>
        <h2 style={{ fontSize: "clamp(28px,4.4vw,46px)", fontWeight: 700, color: "#2C3E50", margin: 0, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
          Sell to the highest bidder. <span style={{ color: "#E8571A" }}>Don't give up 70–80% to the house.</span>
        </h2>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, ...hVisible(hl, 1) }}>
        <div style={{ padding: "24px 26px", background: "#fff", borderRadius: 14, border: "1px solid #E8571A30" }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: "#E8571A", lineHeight: 1.2, marginTop: 2 }}>zero cost.</div>
          <div style={{ fontSize: 13, color: "#6c757d", marginTop: 10, lineHeight: 1.5 }}>Click a button. Sell to the highest bidder. Keep what you earn.</div>
        </div>
        <div style={{ padding: "24px 26px", background: "#fff", borderRadius: 14, border: "1px solid #2C3E5020" }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#2C3E50", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 8 }}>Acquisition + AI</div>
          <div style={{ fontSize: 22, fontWeight: 800, color: "#2C3E50", lineHeight: 1.2 }}>Best acquisition tool —</div>
          <div style={{ fontSize: 22, fontWeight: 800, color: "#E8571A", lineHeight: 1.2, marginTop: 2 }}>real AI intelligence.</div>
          <div style={{ fontSize: 13, color: "#6c757d", marginTop: 10, lineHeight: 1.5 }}>Every investor-friendly agent in your market. Comps, contracts, follow-up — done. <b>3× more efficient.</b></div>
        </div>
      </div>

      <div style={{ padding: "20px 24px", borderRadius: 12, border: "2px dashed #2C3E5040", background: "#fff", fontSize: 15, color: "#2C3E50", lineHeight: 1.55, ...hVisible(hl, 2) }}>
        Let me be straight — this doesn't mean you work less. It means you <b>work smarter, do a lot more, and keep what you earn.</b> If full-time isn't you, we're not it. No harm done.
      </div>
    </div>
  );
}
...
function SectionCTA({ hl }: { hl: number }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28, minHeight: "60vh", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
      <h2 style={{ fontSize: "clamp(28px,4.5vw,44px)", fontWeight: 700, color: "#2C3E50", margin: 0, lineHeight: 1.15, letterSpacing: "-0.02em", maxWidth: 880, ...hVisible(hl, 0) }}>
        I'm not selling you anything. <span style={{ color: "#E8571A" }}>I need the right people.</span>
      </h2>
      <p style={{ fontSize: 17, color: "#2C3E50", maxWidth: 720, margin: 0, lineHeight: 1.55, ...hVisible(hl, 0) }}>
        No three hundred a month. No coach. No guru. No thousand-dollar course that turns into fifteen thousand. If you're willing to work as hard as I did, I'll show you how to make <b>a million and a half a year</b> without somebody else taking most of it. Simple math, great system — not magic.
      </p>

      <div style={{ display: "flex", flexDirection: "column", gap: 14, width: "100%", maxWidth: 480, ...hVisible(hl, 1) }}>
        <a
          href="https://calendly.com/usale/individual-demo"
          target="_blank"
        ...
        >
          Not full-time? Sign up for USale — it's free. The water's warm.
        </a>
      </div>
